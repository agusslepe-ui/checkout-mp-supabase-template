...
document.querySelector("[data-site-header]")?.replaceChildren(createFragment(`<header class="site-header"><div class="site-header__inner shell"><a class="brand" href="index.html" aria-label="LEMONT, inicio"><span class="brand-mark" aria-hidden="true"></span>LEMONT</a><nav class="site-nav" id="site-nav" aria-label="Navegación principal"><ul>${linkMarkup}</ul></nav><a class="header-action header-cart" href="carrito.html" aria-label="Carrito, 0 productos">Carrito <span data-cart-count>0</span></a><button class="menu-button" type="button" aria-controls="site-nav" aria-expanded="false" aria-label="Abrir menú"><span></span></button></div></header>`));
...
function updateCartCount() {
  ...
  link.setAttribute("aria-label", "Carrito, " + count + (count === 1 ? " producto" : " productos"));
}
